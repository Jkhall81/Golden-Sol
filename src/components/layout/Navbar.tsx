...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 h-[100px] w-full backdrop-blur-md dark:bg-stone-800/40 bg-stone-100 border-b border-stone-800 z-50 flex justify-between items-center md:px-6 md:py-3">
        <div className="ml-2">
          <Logo />
        </div>
